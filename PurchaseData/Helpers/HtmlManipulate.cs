...
namespace PurchaseData.Helpers
{
    public class HtmlManipulate
    {
        ...
        public string ReemplazarDatos(DataRow dataRow, Users user, List<RequisitionDetails> details)
        {
            ...
            HtmlDoc.GetElementbyId("DateLast").InnerHtml = $"{string.Format("{0:dd MMMM yyyy}", date)}";
            ...
            var table = HtmlDoc.DocumentNode.SelectSingleNode("/html[1]/body[1]/div[1]/div[1]/div[3]/div[1]/table[1]"); // Tabla detalle productos
                                                                                                                        //var att = HtmlDoc.DocumentNode.SelectSingleNode("/html[1]/body[1]/div[1]/div[1]/div[3]/div[2]"); // Tabla adjuntos
            #region Logos
