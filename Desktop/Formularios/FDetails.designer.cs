...
namespace PurchaseDesktop.Formularios
{
    partial class FDetails
    {
        ...
        private void InitializeComponent()
        {
            ...
            iGColPattern1.Width = 22;
            iGColPattern2.AllowMoving = false;
            iGColPattern2.AllowSizing = false;
            iGColPattern2.CellStyle = this.GridCol7CellStyle;
            iGColPattern2.ColHdrStyle = this.GridCol7ColHdrStyle;
            iGColPattern2.Key = "DetailID";
            iGColPattern2.Visible = false;
            iGColPattern3.Key = "idrow";
            iGColPattern3.Visible = false;
            iGColPattern4.AllowMoving = false;
            iGColPattern4.AllowSizing = false;
            iGColPattern4.Key = "Qty";
            iGColPattern4.Text = "Qty";
            iGColPattern4.Width = 38;
            iGColPattern5.AllowMoving = false;
            iGColPattern5.AllowSizing = false;
            iGColPattern5.Key = "NameProduct";
            iGColPattern5.Text = "Product";
            iGColPattern5.Width = 174;
            iGColPattern6.AllowMoving = false;
            iGColPattern6.AllowSizing = false;
            iGColPattern6.Key = "AccountID";
            iGColPattern6.Text = "Account";
            iGColPattern6.Width = 137;
            iGColPattern7.AllowMoving = false;
            iGColPattern7.AllowSizing = false;
            iGColPattern7.CellStyle = this.GridCol6CellStyle;
            iGColPattern7.ColHdrStyle = this.GridCol6ColHdrStyle;
            iGColPattern7.Key = "Price";
            iGColPattern7.Text = "Price";
            iGColPattern7.Width = 72;
            iGColPattern8.CellStyle = this.GridCol7CellStyle;
            iGColPattern8.Key = "delete";
            iGColPattern8.Width = 24;
